...
Latest milestone tag: [v0.4-detection-handoff](https://github.com/gwonxhj/jetson-orin-nano-internal-lab/releases/tag/v0.4-detection-handoff)
...
- FastAPI `/health`, `/v1/models`, `/metrics`, `/v1/infer/resnet18/synthetic`, `/v1/infer/whisper/speech` API usage flow
...
### 4. YOLOv8n File-Image Object Detection Smoke

외부 카메라 없이 Ultralytics package sample image와 `yolov8n.pt` small model로 object detection inference path를 검증합니다. 이 결과는 detection pipeline evidence이며 broad accuracy나 deployment-ready evidence가 아닙니다.
...
| Model | Backend | Image source | Detections | Mean ms | P95 ms |
|---|---|---|---:|---:|---:|
| YOLOv8n | CUDA | Ultralytics package `bus.jpg` | 6 | 59.5495 | 61.3837 |

### 5. TensorRT FP16 Engine Smoke
...
### 6. ONNX Runtime Inference Smoke
...
### 7. ONNX Runtime CUDA EP Activation Attempt
...
### 8. ONNX Runtime TensorRT EP Activation Attempt
...
### 9. ONNX Runtime TensorRT EP Engine Cache
...
### 10. ONNX Runtime CUDA Env Candidate Probe
...
### 12. FastAPI Local Inference Server
...
### 13. FastAPI Serving InferEdge Export
...
### 15. Whisper Synthetic Path Smoke
...
### 16. Whisper Speech Transcription Smoke
...
### 18. Whisper Env Candidate Probe
...
### 19. LLM Env Candidate Probe and Tiny Text Generation Smoke
