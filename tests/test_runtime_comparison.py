...
def main() -> int:
    ...
    assert result["comparison_name"] == "resnet18_pytorch_cuda_fp32_vs_onnxruntime_cpu_fp32_vs_onnxruntime_cuda_fp32_vs_tensorrt_fp16"
    assert [runtime["name"] for runtime in result["runtimes"]] == ["pytorch_cuda", "onnxruntime_cpu", "onnxruntime_cuda", "tensorrt_trtexec"]
