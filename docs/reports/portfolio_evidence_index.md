...
- A 30-second probe, 10-minute run, and 30-minute sustained run record YOLO detection, FastAPI ResNet18 concurrency, FastAPI Whisper burst, and `tegrastats` telemetry as runtime interaction evidence.
